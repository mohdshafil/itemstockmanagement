...
<tr>
<td> Unit :</td>
<td><input type="text" name="unit" required = "required" placeholder="Enter Unit"></td>
</tr>

<td> Beginning Inventory :</td>
<td><input type="text" name="beginningInventory" required = "required" placeholder="Enter inventorynumber"></td>
</tr>
...
<td> <input type="date" name="dateOfExpiry"  required="required" placeholder="Date Of Expiry" > </td>
</tr>
...
<tr>
<td><label></label></td>
<td><input type="submit"  class="btn btn-dark" value="Add Item"></td>
